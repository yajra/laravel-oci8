...
class OracleGrammar extends Grammar
{
     ...
     * @return string
     */
    protected function modifyNullable(Blueprint $blueprint, Fluent $column, ?bool $currentNullable = null)
    {
    ...
    public function compileChange(Blueprint $blueprint, Fluent $command, Connection $connection)
    {
        ...
        $currentNullable = $this->getCurrentColumnNullable($blueprint, $column->name, $connection);
     ...
     */
    protected function getCurrentColumnNullable(Blueprint $blueprint, string $columnName, Connection $connection): ?bool
    {
        try {
            $table = $blueprint->getTable();
            $schema = $connection->getConfig('username');
