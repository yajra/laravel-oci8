...
class OracleGrammar extends Grammar
{
    ...
    {
        return "select * from ".$this->getSchemaPrefix()."user_tables where upper(table_name) = upper(?)";
    }
    ...
    {
        return "select column_name from ".$this->getSchemaPrefix()."user_tab_columns where table_name = upper('" . $table . "')";
    }
