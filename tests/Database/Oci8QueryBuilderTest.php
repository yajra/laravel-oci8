...
class Oci8QueryBuilderTest extends TestCase
{
    ...
    public function testOffset()
    {
        ...
        $this->assertEquals(
            'select * from (select t1.*, row_number() over (order by ROWID) as rn from (select * from "USERS") t1) where rn >= 11',
            $builder->toSql()
        );
    }
    ...
    public function testLimitsAndOffsets()
    {
        ...
        $this->assertEquals(
            'select * from (select t1.*, row_number() over (order by ROWID) as rn from (select * from "USERS") t1) where rn between 6 and 15',
            $builder->toSql()
        );
        ...
        $builder->select('*')->from('users')->skip(-5)->take(10);
        $this->assertEquals(
            'select * from (select t1.*, row_number() over (order by ROWID) as rn from (select * from "USERS") t1) where rn between 1 and 10',
            $builder->toSql()
        );
        ...
        $this->assertEquals(
            'select * from (select t1.*, row_number() over (order by ROWID) as rn from (select * from "USERS") t1) where rn between 16 and 30',
            $builder->toSql()
        );
        ...
        $builder->select('*')->from('users')->forPage(-2, 15);
        $this->assertEquals(
            'select * from (select t1.*, row_number() over (order by ROWID) as rn from (select * from "USERS") t1) where rn between 1 and 15',
            $builder->toSql()
        );
    }
    ...
    public function testLimitAndOffsetToPaginateOne()
    {
        ...
        $this->assertEquals(
            'select * from (select t1.*, row_number() over (order by ROWID) as rn from (select * from "USERS") t1) where rn between 1 and 1',
            $builder->toSql()
        );
        ...
        $this->assertEquals(
            'select * from (select t1.*, row_number() over (order by ROWID) as rn from (select * from "USERS") t1) where rn between 2 and 2',
            $builder->toSql()
        );
    }
    ...
    public function testForPage()
    {
        ...
        $this->assertSame(
            'select * from (select t1.*, row_number() over (order by ROWID) as rn from (select * from "USERS") t1) where rn between 1 and 0',
            $builder->toSql()
        );
