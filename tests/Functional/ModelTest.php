...
class ModelTest extends TestCase
{
    ...
    #[Test]
    public function it_can_create_model_with_multiple_blob_columns()
    {
        $multiBlob = MultiBlob::create([
            'blob_1' => ['test'],
            'blob_2' => ['test2'],
        ...
        $this->assertNotNull($multiBlob->id);
        $this->assertSame(['test'], $multiBlob->blob_1);
        $this->assertSame(['test2'], $multiBlob->blob_2);
    }
