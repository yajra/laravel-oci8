...
class DatabaseEloquentInverseRelationHasOneTest extends LaravelTestCase
{
    ...
    public function test_has_one_inverse_relation_is_properly_set_to_parent_when_lazy_loaded()
    {
    ...
    public function test_has_one_inverse_relation_is_properly_set_to_parent_when_eager_loaded()
    {
        HasOneInverseChildModel::factory(5)->create();
    ...
    public function test_has_one_inverse_relation_is_properly_set_to_parent_when_making()
    {
    ...
    public function test_has_one_inverse_relation_is_properly_set_to_parent_when_creating()
    {
        $parent = HasOneInverseParentModel::create();
    ...
    public function test_has_one_inverse_relation_is_properly_set_to_parent_when_creating_quietly()
    {
        $parent = HasOneInverseParentModel::create();
    ...
    public function test_has_one_inverse_relation_is_properly_set_to_parent_when_force_creating()
    {
        $parent = HasOneInverseParentModel::create();
    ...
    public function test_has_one_inverse_relation_is_properly_set_to_parent_when_saving()
    {
        $parent = HasOneInverseParentModel::create();
    ...
    public function test_has_one_inverse_relation_is_properly_set_to_parent_when_saving_quietly()
    {
        $parent = HasOneInverseParentModel::create();
        $child = HasOneInverseChildModel::make();
    ...
    public function test_has_one_inverse_relation_is_properly_set_to_parent_when_updating()
    {
        $parent = HasOneInverseParentModel::create();
