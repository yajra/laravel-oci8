...
{
    public function test_creates_pending_attributes_and_pivot_values(): void
    {
    ...
    public function test_queries_pending_attributes_and_pivot_values(): void
    {
    ...
    public function test_morph_to_many_pending_attributes(): void
    {
        $post = new ManyToManyPendingAttributesPost(['id' => 2]);
    ...
    public function test_morphed_by_many_pending_attributes(): void
    {
    ...
    protected function tearDown(): void
    {
        ...
        $this->schema()->drop('pending_attributes_taggables');
