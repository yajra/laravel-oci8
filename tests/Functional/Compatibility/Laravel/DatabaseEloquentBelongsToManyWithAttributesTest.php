...
class DatabaseEloquentBelongsToManyWithAttributesTest extends LaravelTestCase
{
    public function test_creates_with_attributes_and_pivot_values(): void
    {
        ...
        $this->assertEquals($post->id, $pivot->post_id);
        $this->assertEquals($tag->id, $pivot->tag_id);
    }

    public function test_queries_with_attributes_and_pivot_values(): void
    {
    ...
    public function test_morph_to_many_with_attributes(): void
    {
        $post = new ManyToManyWithAttributesPost(['id' => 2]);
    ...
    public function test_morphed_by_many_with_attributes(): void
    {
    ...
    protected function tearDown(): void
    {
        ...
        $this->schema()->drop('with_attributes_taggables');
