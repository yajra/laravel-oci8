...
class DatabaseEloquentTimestampsTest extends LaravelTestCase
{
    /**
     ...
     * Tests...
     */
    public function test_user_with_created_at_and_updated_at()
    {
    ...
    public function test_user_with_created_at()
    {
        Carbon::setTestNow($now = Carbon::now());
    ...
    public function test_user_with_updated_at()
    {
        Carbon::setTestNow($now = Carbon::now());
    ...
    public function test_without_timestamp()
    {
    ...
    public function test_without_timestamp_when_already_ignoring_timestamps()
    {
        Carbon::setTestNow($now = Carbon::now()->setYear(1995)->startOfYear());
        $user = UserWithCreatedAndUpdated::create(['email' => 'foo@example.com']);
        Carbon::setTestNow(Carbon::now()->addHour());
    ...
    public function test_without_timestamp_restores_when_closure_throws_exception()
    {
        $user = UserWithCreatedAndUpdated::create(['email' => 'foo@example.com']);
    ...
    public function test_without_timestamps_respects_classes()
    {
